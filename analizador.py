...
from linguistic import is_past_simple_spacy, is_present_simple_spacy, is_gerund_or_present_participle_spacy, is_past_participle_spacy
...
def analyze_past_participle_spacy(sentence):
    is_past_participle, explanation = is_past_participle_spacy(sentence)
    if is_past_participle:
        return f"The sentence '{sentence}' contains a past participle. {explanation}"
    else:
        return f"The sentence '{sentence}' does not contain a past participle. {explanation}"
